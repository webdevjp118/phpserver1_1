                    ...
                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 breadcrumb_block_in_sdp">
                        <div class="breadcrumb_middle_sdp">
                        	<ol class="breadcrumb">
                           		...
                           		<li class="breadcrumb-item"><a href="javscript:void(0)">FAN CLUB</a></li>                                                              
                        	</ol>                                                                                             
                        </div>                       
                        ...
                        <div class="fan_middle_fp">                        		                        
                            ...
                            <div class="fan_top_fp">
                                <div class="fan_title_fp">
                                    ...
                                    <p>会員登録済みのお客様はログインする事で、<br>会員限定エリアのコンテンツをお楽しみ頂けます</p>
                                </div> 
                                <div class="fan_top_inner_fp">
                                    <div class="fan_box_hp">
                                        <div class="fan_input_row_hp">
                                            <div class="fan_input_text_hp">
                                                ID
                                            </div>
                                            <div class="fan_input_hp">
