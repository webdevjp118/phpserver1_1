                    ...
                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 schedule_block_in_sdp">
                        ...
                        <div class="schedule_middle_sdp">                        		
                            ...
                            <div class="schedule_btn_sdp">
                            	<a class="common_btn_hp common_btn_black_hp common_btn_black_border_hp" href="<?php echo get_site_url(); ?>/info/">一覧へ<img src="<?php echo get_stylesheet_directory_uri(); ?>/images/right_arrow.svg" alt=""></a>
                            </div>                                                                                                               
                        </div>                       
                        <div class="clearfix"></div>
                    </div>
