                    ...
                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 schedule_block_in_sdp">
                        ...
                        <div class="schedule_middle_sdp">                        		
                            ...
                            <div class="schedule_img_sdp">
                            	<a href="javascript:void(0)"><img src="<?php echo get_stylesheet_directory_uri(); ?>/images/schedule_img1.png" alt=""></a>
                            </div>  
                            ...
                            <div class="schedule_btn_sdp">
                            	<a class="common_btn_hp common_btn_black_hp common_btn_black_border_hp" href="<?php echo get_site_url(); ?>/schedule/">スケジュール一覧へ<img src="<?php echo get_stylesheet_directory_uri(); ?>/images/right_arrow.svg" alt=""></a>
                            </div>                                                                                                               
                        </div>                       
                        <div class="clearfix"></div>
                    </div>
