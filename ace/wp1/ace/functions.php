...
function ace_content_width() {
	$GLOBALS['content_width'] = apply_filters( 'ace_content_width', 640 );
}
...
function ace_scripts() {
	wp_enqueue_style( 'ace-style', get_stylesheet_uri(), array(), _S_VERSION );
	wp_style_add_data( 'ace-style', 'rtl', 'replace' );

	wp_enqueue_script( 'ace-navigation', get_template_directory_uri() . '/js/navigation.js', array(), _S_VERSION, true );
