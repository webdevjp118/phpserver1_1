...
<section id="contain">
    ...
    <div class="pg_fv">
        <div class="pgfv_bg" style="background-image: url(<?php echo get_stylesheet_directory_uri(); ?>/images/pg_contact1.jpg);"></div>
        <div class="pgfv_front">
            <div class="pgfv_title">
                <h1 class="X_jp">チームへのお問い合わせ</h1>
            </div>
        </div>
    </div>
    <div class="hx6"></div>
                        ...
                        <div class="field_control">
                            <div class="radio_set">
                                <div class="radio_wrap">
                                    <input class="pneed_reset" type="radio" name="field1" value="対戦希望について" id="radio_field1-1" checked>
                                    <label for="radio_field1-1">対戦希望について</label>
                                </div>
                                <div class="radio_wrap">
                                    <input class="pneed_reset" type="radio" name="field1" value="クラブ/各チームについて" id="radio_field1-2">
                                    <label for="radio_field1-2">クラブ/各チームについて</label>
                                </div>
                                <div class="radio_wrap">
                                    <input class="pneed_reset" type="radio" name="field1" value="グッズについて" id="radio_field1-3">
                                    <label for="radio_field1-3">グッズについて</label>
                                </div>
                                <div class="radio_wrap">
                                    <input class="pneed_reset" type="radio" name="field1" value="サポーターズクラブについて" id="radio_field1-4">
                                    <label for="radio_field1-4">サポーターズクラブについて</label>
                                </div>
                                <div class="radio_wrap">
                                    <input class="pneed_reset" type="radio" name="field1" value="ホームタウンについて" id="radio_field1-5">
                                    <label for="radio_field1-5">ホームタウンについて</label>
                                </div>
                                <div class="radio_wrap">
                                ...
                                <div class="radio_wrap">
                                    <input class="pneed_reset" type="radio" name="field1" value="その他" id="radio_field1-7">
                                    <label for="radio_field1-7">その他</label>
                                </div>
                            </div>
                        </div>
                    </div>
