...
<section id="contain">    	        
				...
				<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 breadcrumb_block_in_sp">
					<div class="breadcrumb_middle_sp">
						<ol class="breadcrumb">
							...
							<li class="breadcrumb-item"><a href="javascript:void(0)"><span>お客様の声</span></a></li>
						</ol>                                                                                             
					</div>                       
					<div class="clearfix"></div>
				</div>
	...
	<div class="staff_block_cp">             
		<div class="container">
			<div class="row">
				<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 staff_block_in_cp">                     	
					<div class="staff_middle_cp">                        		
						<div class="staff_boxes_cp">
<?php
if ( $query->have_posts() ) :
...
?>
							<div class="staff_box_cp">
								<a href="<?php echo $loop_permalink; ?>">
									<div class="staff_box_img_cp">
										<img src="<?php echo $loop_thumb_url; ?>" alt="" />
									</div>
									<div class="staff_box_row_cp">
										<div class="staff_box_info_cp">
											<?php echo $loop_title; ?>
										</div>
									</div>
									<div class="staff_info_cp">
