...
<div class="wrapper">
<!-- HEADER_START -->
<header id="header" class="header_inner_page">
	<div class="header-hp">
			...
			<div class="row">
				<div class="col-lg-12 col-md-12 col-sm-12 col-12 header-in-hp">
					<div class="header-left-hp">
						<div class="logo-hp">
							<a href="<?php echo get_site_url(); ?>/"><img src="<?php echo get_stylesheet_directory_uri(); ?>/images/header_logo_2.png" alt=""/></a>
						</div>
									...
									<div class="header_main_hp">                                        
										<div class="header_menu_top_hp">
											<div class="header_links_hp">
												<h3 class="js_button" data-href="<?php echo get_site_url(); ?>/company/">会社案内</h3>
												<ul>	
										...
										<div class="header_menu_bottom_hp">
											<div class="header_menu_grid_hp">
												...
												<div class="header_menu_box_hp header_menu_pd_hp">
													...
													<div class="header_info_hp">
														<h6><a href="<?php echo get_site_url(); ?>/contact/">メールでのお問い合わせ</a></h6>                                                        
													</div>
					...
					<div class="header_row_hp header_color_hp">
						<div class="header_btn_hp">
							<a href="tel:0466-27-1761"><img src="<?php echo get_stylesheet_directory_uri(); ?>/images/header_call_icon.svg" alt=""/>0466-27-1761<br /> <span>（ 平日 09:00〜17:00 ）</span></a>	
						</div>
