...
<header id="header" class="">
    <div class="header_set">
        ...
        <div class="header_menu">
            ...
            <a class="headmenu_a" href="<?php echo get_site_url(); ?>/functions/">
                <div class="headmenu_shape">
                    <div class="headmenu_cap">使い方と製品機能</div>
                    <div class="headmenu_uline"></div>
                </div>
            </a>
            <a class="headmenu_a" href="<?php echo get_site_url(); ?>/faq/">
                <div class="headmenu_shape">
                    <div class="headmenu_cap">FAQ</div>
                    <div class="headmenu_uline"></div>
                </div>
            </a>
            <a class="headmenu_a" href="<?php echo get_site_url(); ?>/topics/">
                <div class="headmenu_shape">
                    <div class="headmenu_cap">診療報酬</div>
                    <div class="headmenu_uline"></div>
                </div>
            </a>
        </div>
