...
function tcd_add_quicktags() {
  ...
  $tcdQuicktagsL10n = array(
    'pulldown_title' => array(
      ...
      'tag' => __( '<h2 class="style2a" style="border-color:#000000;">Heading 2 styleA</h2>', 'tcd-w' )
		),
		'style2b' => array(
      'display' => __( 'H2 styleB', 'tcd-w' ),
      'tag' => __( '<h2 class="style2b" style="background:#000000;">Heading 2 styleB</h2>', 'tcd-w' )
		),
		'style3a' => array(
      'display' => __( 'H3 styleA', 'tcd-w' ),
      'tag' => __( '<h3 class="style3a" style="border-color:#cccccc;">Heading 3 styleA</h3>', 'tcd-w' )
		),
		'style3b' => array(
      'display' => __( 'H3 styleB', 'tcd-w' ),
      'tag' => __( '<h3 class="style3b" style="border-top-color:#000000;">Heading 3 styleB</h3>', 'tcd-w' )
		),
		'style4a' => array(
      'display' => __( 'H4 styleA', 'tcd-w' ),
      'tag' => __( '<h4 class="style4a" style="border-color:#000000;">Heading 4 styleA</h4>', 'tcd-w' )
		),
		'style4b' => array(
			'display' => __( 'H4 styleB', 'tcd-w' ),
      'tag' => __( '<h4 class="style4b" style="border-left-color:#000000;">Heading 4 styleB</h4>', 'tcd-w' )
		),
		'style5a' => array(
      ...
      'tag' => __( '<h5 class="style5a">Heading 5 styleA</h5>', 'tcd-w' )
		...
		'style5b' => array(
			...
			'tag' => __( '<h5 class="style5b" style="background:#000000;">Heading 5 styleB</h5>', 'tcd-w' )
		),
		'well' => array(
