...
function ogp() {
  ...
  <meta property="og:image:secure_url" content="<?php echo og_image(0); ?>">
  <meta property="og:image:width" content="<?php echo og_image(1); ?>">
  <meta property="og:image:height" content="<?php echo og_image(2); ?>">
  <?php
    if ( $dp_options['fb_app_id'] ) :
  ?>
  ...
  if ( $dp_options['use_twitter_card'] ) :
  ?>
...
if ( $dp_options['use_ogp'] || $dp_options['use_twitter_card'] ) {
