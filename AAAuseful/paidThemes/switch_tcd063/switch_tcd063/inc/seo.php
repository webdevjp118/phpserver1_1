...
function seo_meta_box() {
	...
	add_meta_box(
    'add_seo_option',
    __( 'Meta title and description', 'tcd-w' ),
    'show_seo_meta_box',
    array( 'post', 'page', 'news', 'event', 'special' ),
    'normal',
    'low'
  );
}
...
function save_seo_meta_box( $post_id ) {
	...
	if ( ! isset( $_POST['seo_meta_box_nonce'] ) || ! wp_verify_nonce( $_POST['seo_meta_box_nonce'], 'save_seo_meta_box'  ) ) {
  	return $post_id;
  }
